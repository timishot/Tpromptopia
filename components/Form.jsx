      ...
      <section className='w-full max-w-full flex-start flex-col'>
        ...
        <form onSubmit={handleSubmit} className='mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism'>
          <label>
            ...
            prompt: e.target.value})} placeholder='Write your prompt here'  required className='form_textarea'/>
          </label>
          ...
          <label>
            ...
            tag: e.target.value})} placeholder='#tag'  required className='form_input'/>
          </label>
